...
&nbsp;&nbsp;&nbsp;&nbsp;[2.8 Операторы инкремента (увеличения) и декремента (уменьшения)](#increment-and-decrement-operators)<br />
...
### <a id="increment-and-decrement-operators"></a>2.8 Операторы инкремента (увеличения) и декремента (уменьшения).
Язык C предоставляет два оператора для увеличения или уменьшения переменной.

&nbsp;&nbsp;**++** — оператор инкремента (увеличения);

&nbsp;&nbsp;**--** — оператор декремента (уменьшения).

Эти операторы уменьшают или увеличивают значение переменной на единицу.
Есть две формы записи:

&nbsp;&nbsp;**префиксная** — оператор до переменной *++x*;

&nbsp;&nbsp;**постфиксная** — оператор после переменной *x++*.

Отличие в том, что префиксная форма сначала увеличивает значение переменной, а после возвращает её значение.
Постфиксная сначала возвращает значение переменной, а потом увеличивает его на единицу.
